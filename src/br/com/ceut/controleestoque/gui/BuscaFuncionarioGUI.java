	...
	private void cadastrar() {
		...
		if (gui.getFuncionario() != null) {
			try {
				...
				JOptionPane.showMessageDialog(this, "Não foi possivel cadastrar este funcionário!");
			}
		}
	}
		...
		if (table.getSelectedRow() == -1) {
			...
			if (gui.getFuncionario() != null) {
				try {
					...
					JOptionPane.showMessageDialog(this, "Não foi possivel alterar este funcionário");
				}
				refreshTable();
			}
		}
	...
	private void remover() {
		if (table.getSelectedRow() == -1) {
			...
			try {
				...
				JOptionPane.showMessageDialog(this, "Não foi possivel remover este funcionário!");
			}
		}
	}
}
