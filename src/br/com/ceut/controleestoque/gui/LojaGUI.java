...
//	private JPanel contentPane;
    ...
    CadastroLojas lojas = new CadastroLojas(repositorio);
    CadastroFuncionarios funcionarios = new CadastroFuncionarios();
    CadastroFornecedores fornecedores = new CadastroFornecedores(repositorio);
...
//		setLayout(new BorderLayout(0, 0));
		...
		panelRegistro.setBounds(0, 56, 674, 179);
				...
				.addGroup(gl_panelRegistro.createSequentialGroup()
					.addGroup(gl_panelRegistro.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panelRegistro.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.RELATED)
							.addGroup(gl_panelRegistro.createParallelGroup(Alignment.LEADING)
								.addComponent(button_4, GroupLayout.DEFAULT_SIZE, 59, Short.MAX_VALUE)
								...
								.addComponent(button_5, GroupLayout.DEFAULT_SIZE, 59, Short.MAX_VALUE))
							.addPreferredGap(ComponentPlacement.RELATED)
...
//		System.out.println("3");
		...
		scrollPane.setBounds(0, 236, 674, 226);
...
//		    .addListSelectionListener(listener);
	...
	public void carregarDadosFuncionarios(){
		Funcionario[] listaFuncionarios = funcionarios.listarTudo();
...
//			list_1.setFixedCellHeight( 15 ); // set height
	...
	public void carregarDadosFornecedores(){
		Fornecedor[] listaFornecedores = fornecedores.listarTudo();
			...
			if(!erro.isEmpty()){
                ...
                try {
                	...
                	for(Object nmFuncionario:list_1.getSelectedValues()){
                		...
                		Funcionario funcionario = funcionarios.procurar(nome);
                		boolean jaExiteFuncionario = lojas.existeFuncionario(loja, nome);
            		...
            		for(Object nmFornecedor:list_3.getSelectedValues()){
            			...
            			Fornecedor fornecedor = fornecedores.procurar(nome);
            			boolean jaExiteFornecedor = lojas.existeFornecedor(loja, nome);
		...
		if(linhaSelecionada<0)
			...
			if(!erro.isEmpty()){
                ...
                try {
                	...
                	loja = lojas.procurar(descricaoAntiga);
	                	if(loja!=null){
